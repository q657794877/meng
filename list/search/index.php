...
<meta name="keywords" content="全网免费在线观看<?php echo htmlspecialchars($_GET['keyword'])?>搜索页">
<meta name="description" content="全网免费在线观看<?php echo htmlspecialchars($_GET['keyword'])?>搜索页">
...
<div class="list">
	...
	<div class="more">
		<a class="prev" href="./?keyword=<?php echo urlencode($_GET['keyword'])?>&page=<?php echo $_GET['page'] - 1?>"<?php echo $_GET['page'] <= 1 ? ' style="display:none"' : ''?>><img src="../../static_mi/images/more.png" />上一页</a>
		<a class="next" href="./?keyword=<?php echo urlencode($_GET['keyword'])?>&page=<?php echo $_GET['page'] + 1?>"<?php echo !$data['hasmore'] ? ' style="display:none"' : ''?>>下一页<img src="../../static_mi/images/more.png" /></a>
	</div>
	<?php } ?>
</div>

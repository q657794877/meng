...
<meta name="keywords" content="全网免费在线观看<?php echo htmlspecialchars($data['title'])?>播放页">
<meta name="description" content="全网免费在线观看<?php echo htmlspecialchars($data['title'])?>播放页 - <?php echo htmlspecialchars($data['desc'])?>">
<?php }else{ ?>
<title>资源不存在</title>
<?php } ?>
...
<link rel="stylesheet" type="text/css" href="../static_mi/css/play.css">
</head>

<body class="body">

<div class="header one" style="background:<?php echo $bg_color?>">
	<a class="logo" href="../" style="background-image:url(../static_mi/images/logo.png)"></a>
	<div class="search">
...
<script src="../static_mi/js/play.js"></script>
</body>
</html>